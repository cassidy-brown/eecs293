 ...
 *
 */
public class Agent implements Employee, CheckInTime {
	...
	/**
	 * Helper method to assignToCounter which assigns the Agent to the
	...
	/**
	 * Helper method to assignToCounter which assigns this Agent to the
	 * specified automated counter, if able, and updates the counter set 
	 * as necessary
	 * @param c AutomatedCounter to add to this agent's set of counters
	 */
	...
	public class Test{
		 ...
		 * @param inPerson true if the test agent is at an in-person counter
		 ...
		 * @param initial CounterAssignment to be used prior to assigning
		 * @param toRemove Counter to remove from the agent's assignment
		 * @return CounterAssignment resulting from calling assignToCounter
		 */
