...
public class Supervisor_Test {
	...
	private Supervisor s = new Supervisor();
	private Supervisor.Test test = s.new Test();
	...
	private AutomatedCounter ac1 = new AutomatedCounter(null, new Supervisor());
	private AutomatedCounter ac2 = new AutomatedCounter(null, new Supervisor());
	private AutomatedCounter ac3 = new AutomatedCounter(null, new Supervisor());
	private AutomatedCounter ac4 = new AutomatedCounter(null, new Supervisor());
	...
	public void testAssignToCounter() {
		...
		assertEquals("Assigning an automated counter when at the max number of assingment will do nothing",
				aaAltSet, test.testAssignToCounter(aa, true, ac4));
	}
